...
public class LanguageBean {
    private static volatile LanguageBean languageBean;
    private static final ArrayList<String>Language=new ArrayList<String>();
    private static final ArrayList<String>LanguageCode=new ArrayList<String>();
